...
import { Database, Timer, TimerKind, TimerStorage } from "../../structures"
...
export function attach(ext: ForgeTimers): ITestClient {
    ...
    const harness: ITestClient = {
        ...
        reset() {
            ...
            // a channel one test registered would otherwise still resolve in the next one
            channels.clear()
            channels.set("chan-1", { id: "chan-1" })
...
export type { GapKind } from "../../structures/Timer"
